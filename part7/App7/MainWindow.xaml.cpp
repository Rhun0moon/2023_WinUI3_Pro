...
namespace winrt::App7::implementation
{
    MainWindow::MainWindow()
    {
        ...
        SetWindowPos(hWnd, NULL, 200, 500, 600, 300, NULL);  // 위치 400, 400 크기 600, 300
    }
...
//void winrt::App7::implementation::MainWindow::MenuFlyoutItem_New(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
//{
//    TBlock().Text(L"You Clicked : New");
//}
